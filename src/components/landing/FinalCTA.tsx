              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div className="space-y-2 text-left">
                    ...
                    <input 
                      ...
                      required 
                      type="text" 
                      className="w-full h-11 rounded-lg border border-input bg-background px-4 py-2 text-sm placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
                ...
                <div className="space-y-2 text-left">
                  ...
                  <select 
                    id="package" 
                    name="package"
                    className="w-full h-11 rounded-lg border border-input bg-background px-4 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all appearance-none cursor-pointer"
                  >
                ...
                <div className="space-y-2 text-left">
                  ...
                  <textarea 
                    ...
                    name="message"
                    required 
                    className="w-full min-h-[120px] rounded-lg border border-input bg-background px-4 py-3 text-sm placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-y" 
